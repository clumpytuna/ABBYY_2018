// Автор: Михаил Анухин
// Описание: Файл содержит класс CTypeList и функции для работы с ним.

#ifndef typelist_h
#define typelist_h

// Обертки для списка параметров
// Использовать следующим образом (пример для списка длинны два):
...
// третьим всегда передается тип, возращаемый по умолчанию, в случае если индекс вне
// границ списка.
