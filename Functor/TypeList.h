...
// Список типов. Класс предназначен для хранения типов явном виде
...
class GetTypeAt{
public:
  typedef DefaultType Result; // тип в явном виде
};
...
// списка типов. Если индекс выходит за границу списка, то возвращается
// DefaultType.
